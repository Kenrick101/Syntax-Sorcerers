<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.Master" AutoEventWireup="true" CodeBehind="Product_Page(Other).aspx.cs" Inherits="Watt_Front_end.Product_Page_Other_" %>
    ...
    <div class="product-banner flex-row">
        <div class="grid banner">
            ...
            <div class="banner-picture flex-col">
                <div class="shape-container flex-row"><img class="clip-art-generator" src="./images/Other_Products_Category_Image.jpg" width="140px"></div>
            </div>
        </div>
      </div>
