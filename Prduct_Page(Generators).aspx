<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.Master" AutoEventWireup="true" CodeBehind="Prduct_Page(Generators).aspx.cs" Inherits="Watt_Front_end.Prduct_Page_Generators_" %>
    ...
    <div class="product-banner flex-row">
        <div class="grid banner">
            ...
            <div class="banner-picture flex-col">
                <div class="shape-container flex-row"><img class="clip-art-generator" src="./images/generator_pic.png" width="300px"></div>
            </div>
        </div>
      </div>
